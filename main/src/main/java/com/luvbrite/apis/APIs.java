...
//    public  final String POST_TOOKAN_NOTICATION = "http://localhost:8085/inventory/apps/getTookanNotification?json";
	...
	/*
	 * public final String POST_PRODLIST_URL =
	 * "https://www.luvbrite.com/inventory/apps/acceptproductlist?json"; public
	 * final String NEW_ORDER_URL =
	 * "https://www.luvbrite.com/inventory/apps/a-ordermeta?json"; public final
	 * String UPDATE_ORDER_URL =
	 * "https://www.luvbrite.com/inventory/apps/a-c-ordermeta?json"; public final
	 * String POST_TOOKAN_NOTICATION =
	 * "https://www.luvbrite.com/inventory/apps/getTookanNotification?json";
	 */
